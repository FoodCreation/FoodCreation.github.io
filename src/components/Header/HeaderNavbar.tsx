        ...
        <div className="">
            ...
            <div className="dropdown">
                ...
                <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-slate-100 text-slate-900 rounded-box w-56 right-0 font-bold">
                    <li className="w-1/2"><a href="/#About">About</a></li>
                    <li className="w-1/2"><a href="/teams/web">web班</a></li>
                    <li className="w-1/2"><a href="/teams/menu">メニュー班</a></li>
                    <li className="w-1/2"><a href="/#Contact">Contact</a></li>
                </ul>
            </div>
            {/* 画面サイズが大きいとき用 */}
            <div className="hidden lg:bg-opacity-30 lg:flex lg:items-center lg:justify-between lg:pr-[8rem]">
                <ul className="list-none flex w-80 text-white">
                    <li className="w-1/3 pl-3 btn btn-ghost text-lg"><a href="/#About">About</a></li>
                    <li className="w-1/3 pl-3 btn btn-ghost text-lg"><a href="/teams/web">web班</a></li>
                    <li className="w-1/3 pl-3 btn btn-ghost text-lg"><a href="/teams/menu">メニュー班</a></li>
