                ...
                <div className="bg-opacity-30 flex justify-between pl-3 mx-auto">
                    <ol className="relative border-s-8 border-blue-500">
                        ...
                        <li className="mb-10 ms-4">
                            ...
                            <h3 className="text-lg font-semibold text-gray-900">金沢工大前店オープン<br/>角煮唐麺発売</h3>
                        </li>
                        <div className="absolute w-4 h-4 bg-orange-500 rounded-full mt-1.5 -start-3 border border-white"></div>
                        <li className="mb-10 ms-4">
                        ...
                        <li className="mb-10 ms-4">
                            ...
                            <h3 className="text-lg font-semibold text-gray-900">濃厚旨撃らーめん発売</h3>
                        </li>
                    ...
                    <div className="overflow-x-auto">
                        ...
                        <ul className="timeline flex gap-6 px-4 relative w-max">
                            ...
                            <li>
                                ...
                                <div className="timeline-end timeline-box mt-3 font-semibold bg-white border-white">金沢工大前店オープン<br />&nbsp;角煮唐麺発売</div>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div className="timeline-end timeline-box mt-3 font-semibold bg-white border-white">濃厚旨撃らーめん発売</div>
                            </li>
                        </ul>
                    </div>
                </div>
