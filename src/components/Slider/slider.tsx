...
export default function Slider() { 
    return (
        ...
        {/* ここからデスクトップ向け表示 */} 
        <Swiper className=" [&_.swiper-wrapper]:hidden [&_.swiper-wrapper]:lg:flex " modules={[Autoplay]} loop={true} autoplay={{ delay: 4000 }} > 
        ...
        </Swiper> {/* ここまで */} {/* ここからモバイル向け表示 */} 
        
        <Swiper className=" [&_.swiper-wrapper]:flex [&_.swiper-wrapper]:lg:hidden " modules={[Autoplay]} loop={true} autoplay={{ delay: 4000 }} > 
