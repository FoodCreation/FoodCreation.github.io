    ...
    return (
        <div className="hidden lg:flex lg:items-center lg:justify-center lg:mx-[61px]">
            ...
            <TeamCardDesktop
                ...
                bodytext="Web班では「他学科の学生や職員が出会う場を増やしたい」をコンセプトに８番らーめん金沢工大前店で使えるハチバン初のポイントサイトを開発してます。本気でWebアプリ開発をしたい方、「Web」×「食」に興味がある方を大募集中です！毎週水曜日には開発勉強会も開催し、チームの技術力向上にも力を入れています。興味のある方はぜひ！！！"
                linkUrl="/teams/web"
            />
            <TeamCardDesktop
                title="And More..."
