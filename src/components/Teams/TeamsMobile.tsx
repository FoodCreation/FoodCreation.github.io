...
export default function TeamsMobile() {
    return (
        <div className="lg:hidden">
            <TeamCardMobile title="メニュー班" imageUrl="img/desktop/05_MenuTeam.JPG" bodytext="新メニューの開発やマーケティング、SNSで活動の配信を行っています。食べることが好きな方、データの分析をしてみたい方、マーケティングに興味がある方など大歓迎です！"></TeamCardMobile>
